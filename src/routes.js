			...
			.state('sales.register', {
				...
				controller: function ($scope, $transitions, registers) {
					...
					$transitions.onStart({}, function (transition) {
						...
						let registerIsActive;
						console.log('REGISTROS: ' + registerMannagerCtrl.registers);
						
						if(registerMannagerCtrl.registers.length > 0){
							registerMannagerCtrl.registers[0].isActive || false;
						}
